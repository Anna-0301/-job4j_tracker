...
class AnalyzeByMapTest {
    ...
    public void whenListOfPupilAverage() {
        List<Tuple> average = AnalyzeByMap.averageScoreByPupil(
                List.of(
                        new Pupil("Ivanov",
                                List.of(
                                        new Subject("Math", 100),
    ...
    public void whenListOfSubjectAverage() {
        List<Tuple> average = AnalyzeByMap.averageScoreBySubject(
                List.of(
                        new Pupil("Ivanov",
                                List.of(
                                        new Subject("Math", 70),
    ...
    public void whenBestPupil() {
        Tuple best = AnalyzeByMap.bestStudent(
                List.of(
                        new Pupil("Ivanov",
                                List.of(
                                        new Subject("Math", 100),
    ...
    public void whenBestSubject() {
        Tuple best = AnalyzeByMap.bestSubject(
                List.of(
                        new Pupil("Ivanov",
                                List.of(
                                        new Subject("Math", 100),
